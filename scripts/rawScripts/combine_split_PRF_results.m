...
for n=1:numparts
    load([mainpath filesep '..' filesep '4_retinotopy' filesep 'results_analyzePRF_part_' num2str(n) '_of_' num2str(numparts) '_avg.mat'])
...
save([mainpath filesep '..' filesep '4_retinotopy' filesep 'results_analyzePRF_avg_all.mat'],'resultsall','-v7.3')
disp('done.')